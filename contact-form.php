...
// Configuration
$to_email = 'alabamausafaparents@gmail.com'; // Where form submissions go
...
if ($mail_sent) {
    ...
    echo json_encode([
        'success' => false,
        'message' => 'Sorry, there was an error sending your message. Please email us directly at alabamausafaparents@gmail.com'
    ]);
}
?>
