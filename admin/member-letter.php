...
if (!$member && $q !== '') {
    $like = '%' . $q . '%';
    $s = $pdo->prepare("SELECT id, parent1_first_name, parent1_last_name, cadet_first_name, cadet_middle_name, cadet_last_name, cadet_suffix, membership_year, membership_paid
