...
// 1. Open this page: https://alabamafalcons.org/admin/setup.php
...
.box{background:#fff;border-radius:8px;box-shadow:0 4px 24px rgba(0,0,0,.3);padding:2.5rem;width:100%;max-width:440px}
...
button{width:100%;padding:.75rem;background:#003594;color:#fff;border:none;border-radius:4px;font-size:.95rem;font-weight:700;cursor:pointer}
button:hover{background:#002268}
.alert-error{background:#ffebee;color:#c62828;border-left:4px solid #f44336;padding:.75rem 1rem;border-radius:4px;margin-bottom:1rem;font-size:.875rem}
.hash-box{background:#f5f7fa;border:1px solid #e1e5eb;border-radius:4px;padding:1rem;margin-top:1.25rem;word-break:break-all;font-family:monospace;font-size:.82rem;color:#1a2332}
.steps{background:#e8f5e9;border-left:4px solid #4caf50;padding:.9rem 1rem;border-radius:4px;font-size:.875rem;color:#1b5e20;margin-top:1rem;line-height:1.8}
...
<div class="box">
  ...
  <?php if ($hash): ?>
    <div class="steps">
      <strong>Step 1:</strong> Copy the entire hash below.<br>
    ...
    <div class="warn">⚠️ Delete this file from your server after copying the hash above.</div>
  <?php else: ?>
    <form method="POST">
