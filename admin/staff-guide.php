...
<div class="slide s-content" id="s19">
  ...
  <div class="hbox mt1">
    <strong>Getting members into the portal:</strong> Use the <strong>Send Portal Invite</strong> bulk action on the member roster (filter to Paid, Select All, then Send Portal Invite) to email each parent with their own sign-up link — no manual account creation needed. Anyone who already has a login is skipped automatically. Families who pay dues online (Pay Dues or Update Your Information page) get this invite automatically in their payment confirmation email — or, if they already have a login, a reminder that they do. If a link expires before they use it, resend it from <strong>Users</strong> (shows an "Invite Pending" badge).
  </div>
  <div class="hbox mt1">
