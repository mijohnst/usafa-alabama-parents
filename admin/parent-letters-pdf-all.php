 ...
 * Every saved letter, sorted alphabetically by cadet last name, each
 * preceded by a separator page with the cadet's full name so a printed
 * stack still lines up with alphabetized envelopes after the single PDF
 * gets separated into pages. Sent as a direct download, not opened for
 * printing.
 */
