...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'add' || $action === 'edit') {
        ...
        if (!in_array($role, ['admin','tech','secretary','treasurer','viewer','member'])) $errors[] = 'Invalid role.';
...
$role_labels = ['admin'=>'Admin','tech'=>'Tech Support','secretary'=>'Secretary','treasurer'=>'Treasurer','viewer'=>'Viewer','member'=>'Member'];
$role_colors = ['admin'=>'#002554','tech'=>'#bf360c','secretary'=>'#5c007a','treasurer'=>'#1b5e20','viewer'=>'#5a6a7a','member'=>'#7b3f00'];
